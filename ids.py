...
X = Map_and_Block.Block(0, 2, 'horizontal', 2)
# a = Map_and_Block.Block(0, 4, 'vertical', 2)
# b = Map_and_Block.Block(1, 0, 'vertical', 2)
# c = Map_and_Block.Block(2, 2, 'vertical', 2)
# d = Map_and_Block.Block(4 ,1, 'vertical', 2)
# e = Map_and_Block.Block(3, 4, 'horizontal', 3)
# X = Map_and_Block.Block(0, 2, 'horizontal', 2)
...
print(m,'\n')
# print ('All available moves: ',Map_and_Block.Map.All_Moves(m))
